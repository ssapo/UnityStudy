...
public class GlobalSettings : MonoBehaviour
{
	...
	{
		var PlayersTurn = (TurnManager.Instance.whoseTurn == Players[owner]);
		var NotDrawingAnyCards = !Command.CardDrawPending();
	...
	{
		var PlayersTurn = (TurnManager.Instance.whoseTurn == ownerPlayer);
		var NotDrawingAnyCards = !Command.CardDrawPending();
